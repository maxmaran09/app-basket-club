...
// y comillas escapadas como "" (necesario para notas y detalle de lesión con comas).
...
function descargarPlantilla() {
  const filas = [CSV_HEADERS_TEMPLATE, ...CSV_FILAS_EJEMPLO];
  const csv = filas
  ...
  a.href = url;
  a.download = "plantilla_plantel_propio.csv";
  a.click();
