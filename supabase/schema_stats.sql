...
create or replace view public.vista_promedios_jugador
...
create or replace view public.vista_totales_equipo_partido
with (security_invoker = true) as
...
create or replace view public.vista_record_equipo
with (security_invoker = true) as
...
grant select, insert, update, delete on public.partidos_stats to authenticated;
grant select, insert, update, delete on public.jugador_partido_stats to authenticated;
grant select, insert, update, delete on public.equipo_partido_stats to authenticated;
grant select, insert, update, delete on public.alias_equipo to authenticated;
grant select, insert, update, delete on public.alias_jugador to authenticated;
grant select, insert, update, delete on public.alias_jugador_rival to authenticated;
